...
class TransformersActivity : AppCompatActivity() {
    ...
    private val repoLink = "https://github.com/IODevBlue/BannerX-Transformers"
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        findViewById<Toolbar>(R.id.transformers_toolbar).apply { setNavigationOnClickListener { finish() } }
        ...
        with(ArrayAdapter(this, android.R.layout.simple_spinner_item, Transformers.asStringList())) {
            ...
            (transformersSpinner).run {
                ...
                onItemSelectedListener = object : AdapterView.OnItemSelectedListener {
                    override fun onItemSelected(p0: AdapterView<*>?, p1: View?, p2: Int, p3: Long) { bannerx.bannerXTransformer = Transformers.list[p2] }
